...
interface NoteArchivedModalProps {
  note: Item
  onClose: () => void
...
export function NoteArchivedModal({ note, onClose, onEdit, onReactivate, onDelete }: NoteArchivedModalProps) {
            ...
            <div className="flex items-center justify-between p-4 border-b border-border">
              <div className="flex items-center gap-2 text-gray-400">
                ...
                <span className="font-medium text-text-dark">
                  {isEditMode ? 'Modifier la note' : 'Note archivée'}
                </span>
              </div>
              <button
              ...
              {isEditMode ? (
                ...
                <>
                  ...
                  <div className={`flex items-center gap-1.5 text-sm mt-4 ${contextConfig.colorClass}`}>
                    ...
                    <span className="text-text-muted">Archivée {formatRelativeTime(note.updated_at)}</span>
                  </div>
                </>
              )}
            </div>
