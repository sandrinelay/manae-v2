...
// Icône cercle plein (pour tâche terminée)
export const CheckCircleFilledIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
...
// Icône cercle pointillé (pour tâche rangée)
export const DashedCircleIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
