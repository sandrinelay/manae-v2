...
- [x] Intégration Google Calendar (base)
...
- [ ] Déploiement Vercel
- [ ] Configuration domaine `app.manae.app`
- [ ] Quotas IA (intégration UI)
...
| Token | Valeur | Usage |
|-------|--------|-------|
| Primary | `#14B8A6` (Teal) | Boutons, accents |
| Background | `#F0FDFA` (Mint) | Fond principal |
...
| `https://app.manae.app` | Production (à déployer) |
| `https://manae.app` | Site vitrine + waitlist |
| `https://manae.app/legal/cgu` | CGU |
| `https://manae.app/legal/confidentialite` | Politique confidentialité |
| `https://manae.app/legal/mentions-legales` | Mentions légales |
